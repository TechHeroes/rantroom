The idea is to create a public forum for people to rant about anything under the sun. The forum should allow user registration, login functionality for registered,  email_verified and active users only.
